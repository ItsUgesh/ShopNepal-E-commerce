...
<div id="wpcinvoice_package" class="col-md-12 mb-4">
	<div class="card">
		<section class="card-header">
			<?php echo apply_filters( 'wpcinvoice_multipack_header_label', esc_html__('Packages','wpcargo-invoice') ); ?>
		</section>
			...
			<div id="wpcinvoice-multipack-table-wrapper" class="table-responsive">
				<table id="wpcfe-packages-repeater" class="table table-hover table-sm">
					...
					<tr class="wpc-computation">
						<td colspan="<?php echo wpcfe_mpack_dim_enable() ? 10 : 7 ; ?>"><input data-repeater-create type="button" class="wpc-add btn btn-primary btn-rounded btn-sm" value="<?php esc_html_e('Add Package', 'wpcargo-invoice'); ?>"/></td>
					</tr>
					</tfoot>
				</table>
